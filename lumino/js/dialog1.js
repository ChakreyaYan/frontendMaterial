(function() {
    ...
    var btn_map_open1 = document.getElementById("btn_map_open1");
    var modalDiv;
    var lightboxDiv;
    var modal_title;
    var btn_modal_close;
    ...
    var _closeModal = function() {
        ...
        if (modal_map) {
            ...
            content1.setAttribute("aria-hidden", "false");
    ...
    var _getModalHTML = function() {
        ...
        str = "<h1 tabindex=0 id=modal_title class=modal-title></h1>";
        ...
        str += iframeSrc;
        str += "\" class=img-map src=\"" + img_map1.src + "\" alt=\"Interactive map\">";
    ...
    if (content1 && btn_map_open1) {
        iframeSrc = btn_map_open1.getAttribute("data-iframesrc");
        if (iframeSrc) {
            _addModalBlock();
            _addModalCloseBtn();
            _addLightbox();
            btn_map_open1.addEventListener("click", _openModal, false);
        }
    }
